...
import { FaMotorcycle, FaRoute, FaCheck } from "react-icons/fa";

type ColumnConfig = {
  id: "PRONTO" | "EM_ROTA" | "COMPLETO";
  label: string;
  subtitle: string;
...
const DESPACHO_COLUMNS: ColumnConfig[] = [
  {
    id: "PRONTO",
    label: "Prontos para despacho",
    subtitle: "Separe por motoboy/rota",
    icon: FaMotorcycle,
    headerClasses: "bg-sky-500/10 border border-sky-500/40",
  ...
  },
  {
    id: "EM_ROTA",
    label: "Em rota",
    subtitle: "Acompanhe entregadores",
    icon: FaRoute,
    headerClasses: "bg-indigo-500/10 border border-indigo-500/40",
    badgeClasses: "bg-indigo-500/15 border border-indigo-500/70",
    textClass: "text-indigo-200",
  },
  {
    id: "COMPLETO",
    label: "Entregues",
    subtitle: "Confirme recebimento",
    icon: FaCheck,
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
          <div>
            <h1 className="text-2xl font-semibold text-white flex items-center gap-2">
              <FaMotorcycle className="text-sky-400" />
              Painel de Despacho
            </h1>
            <p className="text-sm text-zinc-400">
              Centralize o fluxo de entregas: organize motoboys, confirme saídas e finalize rotas.
            </p>
          </div>
          <button
